...
class Isomode(object):
    ...
    def prepare_structure(self, pickle_fname='all_modes01.pickle', cif_dir='all_modes0.03'):
        ...
        for ms in [Xa, Xab, XaYb, XabYa, XabYab]:
            for m in ms:
                name=name_modes(m)
                atoms=self.generate_distorted_structure_from_modelist(m, amp=0.03, primitive=True)
