import os
import numpy as np
from nmode import phonon_distort_generator
from pydistort import isodistort


def test_phbst_modes(fname='../data/DionJ/phonon/run.abo_PHBST.nc',qdict = {
        'Gamma': [0.0, 0.0, 0.0],
        'Xy': [0, 0.5, 0],
        #'Xx': [0.5, 0.0, 0],
        'M': [0.5, 0.5, 0],
...
def gen_mode_tails(parent_cif='save.cif',
...
def gen_all():
    ...
    for d in ds:
        ...
        gen_mode_tails(parent_cif='save.cif', distorted_cif=cifname, mode_detail_file=modename+'.txt')
